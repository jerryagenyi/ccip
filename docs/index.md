...
For new developers, start with the [Main Documentation README](./README.md).

## Quick Reference

### Frontend (Vue 3 + Quasar)
- **Location:** `frontend/`
- **Tech Stack:** Vue 3.4 + Quasar 2.14 + TypeScript
- **Architecture:** Component-based with Pinia state management
- **Dev Server:** http://localhost:5173

### Backend (Laravel 11)
- **Location:** `backend/`
- **Tech Stack:** Laravel 11 + PHP 8.2 + PostgreSQL
...
- [API Overview](./api/) - RESTful API documentation
