...
<activation critical="MANDATORY">
  ...
  <menu>
    ...
    <item type="multi">[SPM] Start Party Mode (optionally suggest attendees and topic), [CH] Chat
      <handler match="SPM or fuzzy match start party mode" exec="{project-root}/.bmad/core/workflows/party-mode/workflow.md" data="what is being discussed or suggested with the command, along with custom party custom agents if specified"></handler>
